...
public class BuildConfig{
    ...
    public BuildConfig(String sharedLibName){
        ...
        this.buildDir = new FileHandle("target");
        this.libsDir = new FileHandle("libs");
        this.jniDir = new FileHandle("jni");
    }
    ...
    public BuildConfig(String sharedLibName, String temporaryDir, String libsDir, String jniDir){
        this.sharedLibName = sharedLibName;
        this.buildDir = new FileHandle(temporaryDir);
        this.libsDir = new FileHandle(libsDir);
        this.jniDir = new FileHandle(jniDir);
    }
}
