...
public class AndroidNdkScriptGenerator{
    public void generate(BuildConfig config, BuildTarget target){
        ...
        String template = new FileHandle("scripts/Application.mk.template",
        ...
        template = new FileHandle("scripts/Android.mk.template", FileType.Classpath)
        .readString();
    ...
    private void gatherSourceFiles(FileHandle file, String[] includes, String[] excludes, ArrayList<FileHandle> files){
