...
import io.anuke.jnigen.parsing.*;
import io.anuke.jnigen.parsing.CMethodParser.*;
import io.anuke.jnigen.parsing.JavaMethodParser.*;
...
public class NativeCodeGenerator{
    ...
    throws Exception{
        this.sourceDir = new FileHandle(sourceDir);
    ...
    private void generateCppFile(ArrayList<JavaSegment> javaSegments, FileHandle hFile, FileHandle cppFile)
    throws Exception{
