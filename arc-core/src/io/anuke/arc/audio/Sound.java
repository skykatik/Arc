 ...
 *
 * <p>
 * Calling the {@link #play()} or {@link #play(float)} method will return a int which is an id to that instance of the sound. You
...
public interface Sound extends Disposable{
    ...
    int play(float volume, float pitch, float pan, boolean looping);
    ...
    /**
     * Stops the sound instance with the given id as returned by {@link #play()} or {@link #play(float)}. If the sound is no inter
     ...
     * inter playing, this has no effect.
     * @param soundId the sound id
     */
    ...
    /**
     * Sets the sound instance with the given id to be looping. If the sound is no inter playing this has no effect.s
     * @param soundId the sound id
     ...
     * If the sound is no inter playing, this has no effect.
     * @param soundId the sound id
     * @param pitch the pitch multiplier, 1 == default, >1 == faster, <1 == slower, the value has to be between 0.5 and 2.0
     */
     ...
     * sound is no inter playing, this has no effect.
     * @param soundId the sound id
     ...
     * If the sound is no inter playing, this has no effect. Note that panning only works for mono sounds, not for stereo sounds!
     * @param soundId the sound id
     * @param pan panning in the range -1 (full left) to 1 (full right). 0 is center position.
     * @param volume the volume in the range [0,1].
     */
